			...
			if (seletorArray != null) {
				...
				seletorArray.forEach((o) => {
					if (o.k != null) {
						...
						e.nextElementSibling.nextElementSibling.appendChild(
							divMkSeletorItem
						);
					}
				});
				if (c <= 0) {
					e.nextElementSibling.nextElementSibling.innerHTML = "Nenhuma opção";
				} else if (c > 10) {
					// 	let divMkSeletorItem = document.createElement("div");
					// 	divMkSeletorItem.className = "mkSelItemDeCima";
					// 	divMkSeletorItem.setAttribute("onmousemove", "mkSelMoveCima(this);");
					// 	divMkSeletorItem.innerHTML = "SOBE";
					// 	e.nextElementSibling.nextElementSibling.appendChild(divMkSeletorItem);

					let divMkSeletorItem = document.createElement("div");
					divMkSeletorItem.className = "mkSelItemDeBaixo";
					divMkSeletorItem.setAttribute("onmousemove", "mkSelMoveBaixo(this);");
					divMkSeletorItem.innerHTML = "Descer";
					e.nextElementSibling.nextElementSibling.appendChild(divMkSeletorItem);
				}
			}
		} catch {
