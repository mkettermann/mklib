...
class Mk {
    ...
    atualizarListagem = async () => {
        ...
        if (tablePaginacao) {
            ...
            if (this.c.totalFiltrado > this.c.pagPorPagina)
                ...
                tablePaginacao.setAttribute("hidden", "");
    ...
    atualizarStatusListagem = () => {
        ...
        // Arredondar pra cima, pois a última página pode exibir conteúdo sem preencher o PorPagina
        this.c.totalPaginas = Math.ceil(this.dadosFiltrado.length / this.c.pagPorPagina);
    ...
    processoPaginar = () => {
        ...
        if (this.c.paginaAtual < 5) {
            ...
            if (this.c.totalPaginas - this.c.paginaAtual < 4) {
                ...
                mk.Q(this.c.tablePaginacao + " .pageCod3 a").innerHTML = (this.c.totalPaginas - 4).toString();
                mk.Q(this.c.tablePaginacao + " .pageCod4 a").innerHTML = (this.c.totalPaginas - 3).toString();
                mk.Q(this.c.tablePaginacao + " .pageCod5 a").innerHTML = (this.c.totalPaginas - 2).toString();
                mk.Q(this.c.tablePaginacao + " .pageCod6 a").innerHTML = (this.c.totalPaginas - 1).toString();
                ...
                mk.Qoff(this.c.tablePaginacao + " .pageCod2");
                mk.Q(this.c.tablePaginacao + " .pageCod2 a").innerHTML = "...";
                mk.Q(this.c.tablePaginacao + " .pageCod3 a").innerHTML = (this.c.paginaAtual - 1).toString();
                mk.Q(this.c.tablePaginacao + " .pageCod4 a").innerHTML =
                    this.c.paginaAtual.toString();
                mk.Q(this.c.tablePaginacao + " .pageCod5 a").innerHTML = (this.c.paginaAtual + 1).toString();
                mk.Q(this.c.tablePaginacao + " .pageCod6 a").innerHTML = "...";
                mk.Qoff(this.c.tablePaginacao + " .pageCod6");
            }
        }
