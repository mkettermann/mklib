...
mkMoldeOA = async (dadosOA, modelo = "#modelo", repositorio = ".tableListagem .listBody") => {
    return new Promise((r) => {
...
mkConfirma = async (texto = "Você tem certeza?", p = null) => {
...
mkSelDelRefillProcesso = async (eName, cod = null) => {
...
mkSelDlRefill = async (eName, cod, clear = true) => {
...
contaImportados = 0;
importar = async (tagBuscar = ".divListagemContainer", tipo = "race", quiet = true) => {
