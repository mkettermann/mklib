...
class mktm {
    constructor(o) {
        ...
        this.tag = "input";
        this.atr = "type='text'";
        this.classes = "iConsultas";
        this.lclasses = "";
        this.paiclasses = "";
        this.target = "value";
        this.f = true;
        this.opcoes = "";
        this.tipofiltro = "string";
        this.tipofiltroOperador = "";
        this.field = "";
        this.requer = false;
        this.regras = [];
        this.url = "";
...
class mktc {
    constructor(array) {
        var _c;
        this.url = window.location.href.split("?")[0] + "/GetList";
        this.dados = null;
        this.nomeTabela = null;
        this.container = ".divListagemContainer";
        this.idmodelo = "#modelo";
        this.model = [];
        this.qntInicial = 1000;
        this.qntSolicitada = 5000;
        this.container_importar = false;
        this.filtroExtra = null;
        this.filtro = ".iConsultas";
        this.filtroDinamico = null;
        this.headSort = true;
        this.headMenu = true;
        this.exibeBotaoMais = true;
        this.sortBy = null;
        this.sortDir = 1;
        this.objFiltro = {};
        this.urlOrigem = "";
        ...
        this.totalExibidos = 0;
        this.pagPorPagina = 5;
        this.pagItensIni = 0;
        this.pagItensFim = 0;
        this.totPags = 0;
        this.ativarDbCliente = false;
        this.versaoDb = 1;
        this.tbody = "tbody";
        this.ths = "th";
        this.pagBotoes = ".pagBotoes";
        this.tableResultado = ".tableResultado";
        this.tablePorPagina = "*[name='tablePorPagina']";
        this.tableExibePorPagina = ".tableExibePorPagina";
        this.tableTotal = ".tableTotal";
        this.tableFiltrado = ".tableFiltrado";
        this.tableIni = ".tableIni";
        this.tableFim = ".tableFim";
        this.tableInicioFim = ".tableInicioFim";
        this.pag = ".pag";
        this.pagBotao = ".pagBotao";
        this.botaoAdicionarMaisClasse = "divListagemMaisItens";
        this.botaoNovaConsulta = "#btnConsultar";
        this.dbInit = (store) => { };
        this.aoIniciarListagem = (este) => __awaiter(this, void 0, void 0, function* () { });
        this.aoReceberNovaConsulta = (dadosFull, este) => __awaiter(this, void 0, void 0, function* () { });
        this.aoPossuirDados = (dadosFull, este) => __awaiter(this, void 0, void 0, function* () { });
        this.aoConcluirFiltragem = (dadosFiltrado, este) => __awaiter(this, void 0, void 0, function* () { });
        this.aoAntesDePopularTabela = (dadosExibidos, este) => __awaiter(this, void 0, void 0, function* () { });
        this.aoConcluirExibicao = (este) => __awaiter(this, void 0, void 0, function* () { });
        this.aoReceberDados = (o, este) => { return o; };
        this.aoAddEditDelLista = (operacao, objeto, este) => __awaiter(this, void 0, void 0, function* () { });
        this.set = (propriedade, valor) => {
        ...
        if (this.url) {
            this.url = (_c = this.url) === null || _c === void 0 ? void 0 : _c.replace("//GetList", "/GetList");
        }
...
class mkt {
    constructor(_mktc) {
        ...
        this.totalappends = 0;
        this.autoStartConfig = (arg = {}) => __awaiter(this, void 0, void 0, function* () {
            if (!this.started) {
                if (this.c.container_importar) {
                    yield mkt.importar(this.c.container);
                }
                ...
                if (mkt.Q(this.c.tablePorPagina)) {
                    mkt.Ao("input", this.c.tablePorPagina, (e) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.c.dados != null) {
                if (mkt.classof(this.c.dados) == "Array") {
                    if (this.c.qntInicial > 0) {
                        if ((yield this.appendList(this.c.dados)) != null) {
                            this.started = true;
                            this.startListagem();
                        }
                    }
            ...
            if (this.c.url != null) {
                if (mkt.classof(this.c.url) == "String") {
                    ...
                    if (this.c.qntInicial > 0) {
                        if ((yield this.appendList(this.c.url)) != null) {
                            if (!this.started) {
                                this.started = true;
                                this.startListagem();
                            }
        ...
        this.reset = () => __awaiter(this, void 0, void 0, function* () {
            ...
            this.totalappends = 0;
            this.c.objFiltro = {};
            yield this.autoStartConfig();
        });
        this.mais = (parametros = null, novaurl = null) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.appendList = (data_url, parametros = "", fromMais = false) => __awaiter(this, void 0, void 0, function* () {
            return new Promise((r) => {
                if (mkt.classof(data_url) == "Array") {
                    ...
                    if (data_url.includes("?")) {
                        ...
                        urlTemp = (data_url === null || data_url === void 0 ? void 0 : data_url.split("?")[0]) + "?lr=" + solicitar + "&lh=" + this.cTotUltimoParametro;
                    }
                    if (!urlTemp.includes("://"))
                    ...
                    mkt.get.json({ url: urlTemp, carregador: carregador }).then((p) => {
                        ...
                        if (p.retorno != null) {
                            ...
                            if (this.ultimoGet < this.solicitadoUltimoParametro) {
                                ...
                                let eAddMais = (_c = mkt.Q(this.c.container)) === null || _c === void 0 ? void 0 : _c.querySelector("." + this.c.botaoAdicionarMaisClasse);
                                if (eAddMais) {
                                    eAddMais.remove();
                                }
                            }
        ...
        this.startListagem = (arg = {}) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.c.aoPossuirDados(this.dadosFull, this);
        ...
        this.dbCon = () => __awaiter(this, void 0, void 0, function* () {
            return new Promise((r) => {
        ...
        this.atualizarListagem = () => __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.c.aoConcluirFiltragem(this.dadosFiltrado, this);
            if (this.c.totalFiltrado > this.c.pagPorPagina)
                pagBotoes === null || pagBotoes === void 0 ? void 0 : pagBotoes.removeAttribute("hidden");
            else
                pagBotoes === null || pagBotoes === void 0 ? void 0 : pagBotoes.setAttribute("hidden", "");
            if (this.c.totalFiltrado == 0) {
                (_f = mkt.Q(this.c.tableInicioFim)) === null || _f === void 0 ? void 0 : _f.setAttribute("hidden", "");
                (_g = mkt.Q(this.c.tableExibePorPagina)) === null || _g === void 0 ? void 0 : _g.setAttribute("hidden", "");
                (_h = mkt.Q(this.c.tbody)) === null || _h === void 0 ? void 0 : _h.setAttribute("hidden", "");
                this.dadosExibidos = [];
            }
            else {
                if (pagBotoes) {
                    (_j = mkt.Q(this.c.tableInicioFim)) === null || _j === void 0 ? void 0 : _j.removeAttribute("hidden");
                    (_k = mkt.Q(this.c.tableExibePorPagina)) === null || _k === void 0 ? void 0 : _k.removeAttribute("hidden");
                    this.processoPaginar();
                }
                else {
                    this.dadosExibidos = this.dadosFiltrado;
                }
                (_l = mkt.Q(this.c.tbody)) === null || _l === void 0 ? void 0 : _l.removeAttribute("hidden");
                mkt.Q(this.c.container).dispatchEvent(new CustomEvent("aoAntesDePopularTabela"));
                yield this.c.aoAntesDePopularTabela(this.dadosExibidos, this);
                    ...
                    if (this.aindaTemMais) {
                        if (this.c.totPags == this.c.pagAtual) {
                            ...
                            if (!container.querySelector("." + this.c.botaoAdicionarMaisClasse)) {
                                ...
                                (_o = (_m = container.querySelector("table")) === null || _m === void 0 ? void 0 : _m.parentElement) === null || _o === void 0 ? void 0 : _o.appendChild(mklEFim);
                            }
                        }
                        else {
                            (_p = mkt.Q(this.c.container + " ." + this.c.botaoAdicionarMaisClasse)) === null || _p === void 0 ? void 0 : _p.remove();
                        }
                    }
                }
                yield mkt.moldeOA(this.dadosExibidos, this.c.idmodelo, this.c.tbody);
                mkt.Q(this.c.container).dispatchEvent(new CustomEvent("aoConcluirExibicao"));
                yield this.c.aoConcluirExibicao(this);
            }
        });
        this.atualizarStatusListagem = () => {
        ...
        this.atualizaNaPaginaUm = () => __awaiter(this, void 0, void 0, function* () {
            this.c.pagAtual = 1;
            this.atualizarListagem();
        });
        this.mudaPag = (e) => {
        ...
        this.updateFiltroElemento = (e) => {
            ...
            if (e.value != null && e.getAttribute("data-mkfignore") != "true") {
                ...
                if (tipo == "date") {
                    ...
                    if (eData.length >= 2) {
                        this.c.objFiltro[e.name].operador = (_c = eData[0]) === null || _c === void 0 ? void 0 : _c.getAttribute("data-tipofiltroOperador");
                        this.c.objFiltro[e.name].operador2 = (_d = eData[1]) === null || _d === void 0 ? void 0 : _d.getAttribute("data-tipofiltroOperador");
                        if (((_e = eData[0]) === null || _e === void 0 ? void 0 : _e.value) != "")
                            this.c.objFiltro[e.name].conteudo = (_f = eData[0]) === null || _f === void 0 ? void 0 : _f.value;
                        if (((_g = eData[1]) === null || _g === void 0 ? void 0 : _g.value) != "")
                            this.c.objFiltro[e.name].conteudo2 = (_h = eData[1]) === null || _h === void 0 ? void 0 : _h.value;
                    }
                }
            }
        ...
        this.headMenuAbrir = (colName) => __awaiter(this, void 0, void 0, function* () {
			...
			<div class='hmin fimsecao'>
                ...
                mkt.Ao("click", ".mkHeadMenu .hmPrevious", (e) => {
                    ...
                    mkt.hm.Previous(eHmenu === null || eHmenu === void 0 ? void 0 : eHmenu.getAttribute("data-colname"), eHmenu === null || eHmenu === void 0 ? void 0 : eHmenu.getAttribute("data-mkt"));
                });
                mkt.Ao("click", ".mkHeadMenu .hmNext", (e) => {
                    let eHmenu = mkt.Q("body .mkHeadMenu");
                    mkt.hm.Next(eHmenu === null || eHmenu === void 0 ? void 0 : eHmenu.getAttribute("data-colname"), eHmenu === null || eHmenu === void 0 ? void 0 : eHmenu.getAttribute("data-mkt"));
                });
                mkt.Ao("click", ".mkHeadMenu .hmHide", (e) => {
                    var _c;
                    (_c = mkt.Q("body .mkHeadMenu")) === null || _c === void 0 ? void 0 : _c.classList.add("oculto");
                });
                mkt.Ao("click", ".mkHeadMenu .hmCrescente", (e) => {
                    let eHmenu = mkt.Q("body .mkHeadMenu");
                    mkt.hm.Crescente(eHmenu === null || eHmenu === void 0 ? void 0 : eHmenu.getAttribute("data-colname"), eHmenu === null || eHmenu === void 0 ? void 0 : eHmenu.getAttribute("data-mkt"));
                });
                mkt.Ao("click", ".mkHeadMenu .hmDecrescente", (e) => {
                    let eHmenu = mkt.Q("body .mkHeadMenu");
                    mkt.hm.Decrescente(eHmenu === null || eHmenu === void 0 ? void 0 : eHmenu.getAttribute("data-colname"), eHmenu === null || eHmenu === void 0 ? void 0 : eHmenu.getAttribute("data-mkt"));
                });
                mkt.Ao("click", ".mkHeadMenu .hmLimpar", (e) => {
                    let eHmenu = mkt.Q("body .mkHeadMenu");
                    mkt.hm.Limpar(eHmenu === null || eHmenu === void 0 ? void 0 : eHmenu.getAttribute("data-colname"), eHmenu === null || eHmenu === void 0 ? void 0 : eHmenu.getAttribute("data-mkt"));
                });
                mkt.Ao("click", ".mkHeadMenu .hmLimparTodos", (e) => {
                    let eHmenu = mkt.Q("body .mkHeadMenu");
                    mkt.hm.LimparTodos(eHmenu === null || eHmenu === void 0 ? void 0 : eHmenu.getAttribute("data-colname"), eHmenu === null || eHmenu === void 0 ? void 0 : eHmenu.getAttribute("data-mkt"));
                });
                mkt.Ao("input", ".mkHeadMenu .hmFiltraExclusivo", (e) => {
                    var _c;
                    mkt.hm.FiltraExclusivo(e.value, (_c = e.closest(".mkHeadMenu")) === null || _c === void 0 ? void 0 : _c.getAttribute("data-mkt"));
                });
                mkt.Ao("input", ".mkHeadMenu .hmContemInput", (e) => {
                    var _c;
                    let eHmenu = mkt.Q("body .mkHeadMenu");
                    mkt.hm.ContemInput(e.value, eHmenu === null || eHmenu === void 0 ? void 0 : eHmenu.getAttribute("data-colname"), (_c = e.closest(".mkHeadMenu")) === null || _c === void 0 ? void 0 : _c.getAttribute("data-mkt"));
                });
            }
            ...
            if (((_q = this.c.objFiltro[colName]) === null || _q === void 0 ? void 0 : _q.formato) == "string") {
                mkt.Q(".mkHeadMenu input[name='filtrarCampo']").value = (_r = this.c.objFiltro[colName]) === null || _r === void 0 ? void 0 : _r.conteudo;
            }
            else {
                mkt.Q(".mkHeadMenu input[name='filtrarCampo']").value = "";
            }
            mkt.Q(".mkHeadMenu input[name='filtrarPossibilidades']").value = "";
            if (((_s = this.c.objFiltro[colName]) === null || _s === void 0 ? void 0 : _s.formato) == "mkHeadMenuSel") {
                this.hmunsel = this.c.objFiltro[colName].conteudo;
            }
            else {
                this.hmunsel = [];
            }
            this.exclusivos = yield mkt.addTask({ k: "Exclusivos", v: this.dadosFull });
            this.exclusivos = this.exclusivos.v[colName.split(".")[0]];
            let exclusivosProcessado = [];
            if (colName.includes(".")) {
                (_t = this.exclusivos) === null || _t === void 0 ? void 0 : _t.forEach((ex) => {
            ...
            let esteLabel = (_v = (_u = this.getModel().filter((f) => { return f.k == colName; })) === null || _u === void 0 ? void 0 : _u[0]) === null || _v === void 0 ? void 0 : _v.l;
            if (esteLabel) {
                colNameLabel = esteLabel;
            }
            if (colNameLabel == colName) {
                if (eHead) {
                    colNameLabel = eHead === null || eHead === void 0 ? void 0 : eHead.innerHTML;
                }
                else {
        ...
        this.setDirSort = (propriedade, direcao = 2) => {
            if (propriedade != null) {
                if (direcao == 2) {
        ...
        this.orderBy = (propriedade, direcao = 2) => {
        ...
        this.clearFiltro = (campoEspecifico = null) => {
            if (campoEspecifico) {
        ...
        this.clearFiltroUpdate = () => {
            this.clearFiltro();
            this.atualizarListagem();
        };
        this.getObj = (valorKey) => {
            let temp = null;
            ...
            if (valorKey) {
                ...
                if (obj != null) {
                    ...
                    model.forEach((i) => {
                        ...
                        i.field = field === null || field === void 0 ? void 0 : field.outerHTML;
                    });
                    return model;
                }
                else {
        ...
        this.getUsedKeys = (formatoKV = false) => {
            let kv = [];
            let chaves = new Set();
            this.dadosFull.forEach((o) => {
        ...
        this.add = (objDados, ordenar = true, comEvento = true) => {
            ...
            this.atualizarListagem().then(re => {
                ...
                if (pkV != null) {
                    this.getAllTr().forEach(tr => {
                        if (tr.id == pkV) {
                            mkt.timerClasse(tr, "displayLinhaNova", 4000);
                        }
                    });
                }
            });
        ...
        this.edit = (objDados, k, v, ordenar = true, comEvento = true) => {
            objDados = this.c.aoReceberDados(objDados, this);
        ...
        if (mkt.classof(this.c.model) != "Array")
            this.c.model = [];
        if (((_c = this.c.model) === null || _c === void 0 ? void 0 : _c.length) > 0) {
            (_d = this.c.model) === null || _d === void 0 ? void 0 : _d.forEach(o => {
                if (o.pk) {
                    this.c.pk = o.k;
                }
            });
        ...
        if (this.c.pk == null) {
            let modelo = (_e = mkt.Q(this.c.idmodelo)) === null || _e === void 0 ? void 0 : _e.getAttribute("pk");
            if (modelo) {
                this.c.pk = modelo;
            }
            else {
...
mkt.QverOff = (query = "body") => {
    return mkt.aCadaElemento(query, (e) => {
        e === null || e === void 0 ? void 0 : e.classList.add("oculto");
    });
};
mkt.QverOn = (query = "body") => {
    return mkt.aCadaElemento(query, (e) => {
        e === null || e === void 0 ? void 0 : e.classList.remove("oculto");
    });
};
mkt.Qoff = (query = "body") => {
    return mkt.aCadaElemento(query, (e) => {
...
mkt.Ao = (tipoEvento = "click", query, executar, autoExecutar = false, config = mkt.a.AoConfig) => {
...
mkt.atribuir = (e, gatilho, atributo = "oninput") => {
    if (e) {
        if (atributo) {
            ...
            if (tipo == "Function") {
                ...
                let attr = e === null || e === void 0 ? void 0 : e.getAttribute(atributo);
                if (attr) {
                    if (!attr.includes(gatilho)) {
                        e === null || e === void 0 ? void 0 : e.setAttribute(atributo, attr + ";" + gatilho);
                    }
                }
                else {
                    e === null || e === void 0 ? void 0 : e.setAttribute(atributo, gatilho);
                }
            }
            else {
...
mkt.QSetAll = (query = "input[name='#PROP#']", dados = null, comEvento = true) => {
    let eAfetados = [];
...
mkt.QSubSet = (queryContainer, dados, eventInput = true) => {
    let eAfetados = [];
    if (mkt.classof(dados) == "Object") {
...
mkt.Qison = (query = "body") => {
    return (mkt.QAll(query).some((e) => { return e.classList.contains("disabled"); }))
        ? false
        : true;
};
mkt.QverToggle = (query = "body") => {
    return mkt.aCadaElemento(query, (e) => {
        e === null || e === void 0 ? void 0 : e.classList.toggle("oculto");
    });
};
mkt.l = (...s) => {
    if (mkt.a.log) {
...
mkt.moldeOA = (dados, modelo = "#modelo", repositorio = ".tableListagem .listBody", allowTags = false, removeAspas = false) => __awaiter(void 0, void 0, void 0, function* () {
    return new Promise((r) => {
...
mkt.processoFiltragem = (aTotal, objFiltro, inst) => {
    let aFiltrada = [];
...
mkt.delObjetoFromId = (nomeKey, valorKey, listaDados) => {
    let temp = [];
...
mkt.setObjetoFromId = (nomeKey, valorKey, itemModificado, listaDados) => {
    if (Array.isArray(listaDados)) {
...
mkt.hm = {
    Hide: (ev) => {
        ...
        if (!ethm) {
            ehm === null || ehm === void 0 ? void 0 : ehm.classList.add("oculto");
        }
    },
    ...
    FiltraExclusivo: (v, iof) => {
        ...
        if (mkt.classof(iof) == "String") {
            ...
            let exFiltrado = (_c = mkt.getThis(Number(iof)).exclusivos) === null || _c === void 0 ? void 0 : _c.filter((f) => {
            ...
            mkt.Ao("click", ".mkHeadMenu .hmMarcarExclusivos", (e) => {
                let eHmenu = mkt.Q("body .mkHeadMenu");
                if ((e === null || e === void 0 ? void 0 : e.id) == "headMenuTodos") {
                    e = null;
                }
                mkt.hm.MarcarExclusivos(e, eHmenu === null || eHmenu === void 0 ? void 0 : eHmenu.getAttribute("data-colname"), eHmenu === null || eHmenu === void 0 ? void 0 : eHmenu.getAttribute("data-mkt"));
            });
        }
        else {
...
mkt.CarregarHtml = (estilo = "", classe = "relative") => {
    return `<div class="CarregadorMk ${classe}" style="${estilo}"></div>`;
};
mkt.detectedServerOff = (mensagem = "Servidor OFF-LINE") => {
...
mkt.detectedServerOn = () => {
    var _c, _d;
    (_d = (_c = mkt.Q("body .offlineBlock")) === null || _c === void 0 ? void 0 : _c.classList) === null || _d === void 0 ? void 0 : _d.add("oculto");
    mkt.Q("body").classList.remove("CarregadorMkSemScrollY");
};
mkt.importar = (tagBuscar = ".divListagemContainer", tipo = "race", quiet = true) => __awaiter(void 0, void 0, void 0, function* () {
    return new Promise((r, x) => {
        ...
        Promise[tipo](ps.map((x) => { return x.p; })).then((ret) => {
            ps.forEach((o) => __awaiter(void 0, void 0, void 0, function* () {
                let re = yield o.p;
                if (re.retorno != null) {
...
mkt.post = {
    json: (config, json) => __awaiter(void 0, void 0, void 0, function* () {
        if (typeof config != "object")
            config = { url: config };
        config.metodo = mkt.a.POST;
        config.tipo = mkt.a.JSON;
        config.dados = json;
        let retorno = yield mkt.request(config);
        return retorno;
    }),
    html: (config, text) => __awaiter(void 0, void 0, void 0, function* () {
        if (typeof config != "object")
            config = { url: config };
        config.metodo = mkt.a.POST;
    ...
    form: (config, formdata) => __awaiter(void 0, void 0, void 0, function* () {
        if (typeof config != "object")
            config = { url: config };
        config.metodo = mkt.a.POST;
...
mkt.get = {
    json: (config) => __awaiter(void 0, void 0, void 0, function* () {
        if (typeof config != "object")
            config = { url: config };
        config.metodo = mkt.a.GET;
        config.tipo = mkt.a.JSON;
        return yield mkt.request(config);
    }),
    html: (config) => __awaiter(void 0, void 0, void 0, function* () {
        if (typeof config != "object")
            config = { url: config };
        config.metodo = mkt.a.GET;
        config.tipo = mkt.a.HTML;
    ...
    blob: (config) => __awaiter(void 0, void 0, void 0, function* () {
        if (typeof config != "object")
            config = { url: config };
        config.metodo = mkt.a.GET;
...
mkt.request = (config) => __awaiter(void 0, void 0, void 0, function* () {
    var _c, _d;
    if (typeof config != "object") {
    ...
    if (!(config === null || config === void 0 ? void 0 : config.url)) {
        ...
        return { url: config === null || config === void 0 ? void 0 : config.url, retorno: null };
    }
    if (!(config === null || config === void 0 ? void 0 : config.metodo)) {
    ...
    if (!(config === null || config === void 0 ? void 0 : config.tipo)) {
    ...
    if (!(config === null || config === void 0 ? void 0 : config.headers)) {
        ...
        let aft = (_c = mkt.Q("input[name='__RequestVerificationToken']")) === null || _c === void 0 ? void 0 : _c.value;
    ...
    try {
        config.pacote = yield fetch(config.url, {
        ...
        if (!config.pacote.ok) {
            ...
            config.erros = yield config.pacote.text();
            ...
            if (config.statusCode != 204) {
                if (config.tipo == mkt.a.JSON) {
                    config.retorno = yield config.pacote.json();
                }
                else if (config.tipo == mkt.a.HTML) {
                    config.retorno = yield config.pacote.text();
                }
                else if (config.tipo == mkt.a.ALL) {
                    config.retorno = yield config.pacote.blob();
                }
                else if (config.tipo == mkt.a.FORMDATA) {
                    config.retorno = yield config.pacote.json();
                }
            ...
            if (!config.quiet) {
                let tam = (_d = config.retorno) === null || _d === void 0 ? void 0 : _d.length;
                if (!tam) {
                    tam = "";
                }
                else {
...
mkt.mkConfirma = (texto = "Você tem certeza?", p = null) => __awaiter(void 0, void 0, void 0, function* () {
    let corSim = "bVerde";
    if ((p === null || p === void 0 ? void 0 : p.corSim) != undefined)
        corSim = p.corSim;
    let corNao = "bCinza";
    if ((p === null || p === void 0 ? void 0 : p.corNao) != undefined)
        corNao = p.corNao;
    let emSim = "Sim";
    if ((p === null || p === void 0 ? void 0 : p.emSim) != undefined)
        emSim = p.emSim;
    let emNao = "N&#227;o";
    if ((p === null || p === void 0 ? void 0 : p.emNao) != undefined)
        emNao = p.emNao;
    let titulo = "Confirmação";
    if ((p === null || p === void 0 ? void 0 : p.titulo) != undefined)
        titulo = p.titulo;
    let fnFora = () => { return mkt.w("Selecione apenas as opções da tela."); };
    if ((p === null || p === void 0 ? void 0 : p.fnFora) != undefined)
        fnFora = p.fnFora;
    let classContainer = "";
    if ((p === null || p === void 0 ? void 0 : p.classContainer) != undefined)
        classContainer = p.classContainer;
    return new Promise((r) => {
        if (!document.querySelector(".mkConfirmadorBloco")) {
            mkt.Q("body").insertAdjacentHTML("beforeEnd", `<div class="mkConfirmadorBloco microPos5 oculto">
					<div class="mkConfirmadorFora" onclick="mkt.mkConfirmaFuncaoFora()"></div>
					<div class="mkConfirmadorArea microPos5 tb fsb ${classContainer}">
						<div class="mkConfirmadorTitulo">
							...
							<span class="mkConfirmadorTituloInner">${titulo}</span>
						</div>
						<div class="mkConfirmadorTexto">${texto}</div>
						<div class="mkConfirmadorBotoes fsb">
							<button class="bBotao icoSim ${corSim}" onclick="this.classList.add(true);">${emSim}</button>
							<button class="bBotao icoNao ${corNao}" onclick="this.classList.add(true);">${emNao}</button>
						</div>
					</div>
				</div>`);
        }
        ...
        mkt.Q(".mkConfirmadorBloco .mkConfirmadorTexto").innerHTML = texto;
        mkt.Q(".mkConfirmadorBloco .bBotao.icoSim").innerHTML = emSim;
        mkt.Q(".mkConfirmadorBloco .bBotao.icoNao").innerHTML = emNao;
...
mkt.dataFormatarSOA = (soa, reverse = false) => {
...
mkt.masterFormatarSOA = (soa) => {
    return mkt.dataFormatarSOA(mkt.limparOA(soa));
};
mkt.dataToLocale = (data) => {
...
mkt.dataGetSegundosDiferenca = (msOld, msNew = null) => {
    if (msNew == null)
        msNew = mkt.dataGetMs();
    return mkt.dataMsToSegundos(msNew - msOld);
};
mkt.dataGetDiasDiferenca = (msOld, msNew = null) => {
    if (msNew == null)
        msNew = mkt.dataGetMs();
    return mkt.dataMsToDias(msNew - msOld);
};
mkt.dataGetTempoDiferenca = (msOld, msNew = null) => {
...
mkt.dataMsToSegundos = (num, reverse = false) => {
    if (reverse) {
        return num * 1000;
    }
    return Math.trunc(num / 1000);
};
mkt.dataMsToMinutos = (num, reverse = false) => {
    if (reverse) {
        return num * 60000;
    }
    return Math.trunc(num / 60000);
};
mkt.dataMsToHoras = (num, reverse = false) => {
    if (reverse) {
        return num * 3600000;
    }
    return Math.trunc(num / 3600000);
};
mkt.dataMsToDias = (num, reverse = false) => {
    if (reverse) {
        return Math.trunc(num * 86400000);
    }
    return Math.trunc(num / 86400000);
};
mkt.mkRecChange = (recItem, texto) => {
    var _c;
    let e = (_c = recItem === null || recItem === void 0 ? void 0 : recItem.parentElement) === null || _c === void 0 ? void 0 : _c.previousElementSibling;
    if (e) {
        e.value = texto;
        mkt.wait(10).then(r => {
            mkt.mkRecUpdate(e);
...
mkt.mkRecFoco = (input, f) => {
    let eList = input === null || input === void 0 ? void 0 : input.nextElementSibling;
    if (eList) {
        if (!f) {
...
mkt.mkRecRenderizar = () => __awaiter(void 0, void 0, void 0, function* () {
    mkt.QAll("input.mkRec").forEach((e) => __awaiter(void 0, void 0, void 0, function* () {
        var _e;
        if (!((_e = e.nextElementSibling) === null || _e === void 0 ? void 0 : _e.classList.contains("mkRecList"))) {
            let ePai = e.parentElement;
            let ePos = Array.from(ePai === null || ePai === void 0 ? void 0 : ePai.children).indexOf(e);
            let divMkRecList = document.createElement("div");
            divMkRecList.className = "mkRecList emFoco";
            divMkRecList.setAttribute("tabindex", "-1");
            ePai === null || ePai === void 0 ? void 0 : ePai.insertBefore(divMkRecList, ePai === null || ePai === void 0 ? void 0 : ePai.children[ePos + 1]);
...
mkt.mkRecUpdate = (e) => {
    if ((e === null || e === void 0 ? void 0 : e.getAttribute("data-selarray")) != "") {
...
mkt.regras = [];
mkt.regraExe = (e, tipoEvento = "blur", ev = null) => __awaiter(void 0, void 0, void 0, function* () {
    return new Promise((resolver) => {
        ...
        let eDisplay = regrasDoE === null || regrasDoE === void 0 ? void 0 : regrasDoE.c.querySelector(".mkRegrar[data-valmsg-for='" + regrasDoE.n + "']");
        let regras = regrasDoE === null || regrasDoE === void 0 ? void 0 : regrasDoE.r;
        let promises = [];
        if (regras) {
            regras.forEach((re) => {
                if (!re.target) {
                ...
                if (podeValidar || re.f) {
                    promises.push(new Promise((prom) => {
                        var _c, _d;
                        re.e = e;
                        let regraK = (_c = re.k) === null || _c === void 0 ? void 0 : _c.toLowerCase();
                        switch (regraK) {
                            case "mascarar":
                                if (e[re.target]) {
                            ...
                            case "obrigatorio":
                                ...
                                if (re.v == "true") {
                                    if (e[re.target] == undefined) {
                                        e[re.target] = (_d = e.getAttribute(re.target)) !== null && _d !== void 0 ? _d : "";
                                    }
                                    if (e[re.target] == "") {
                                        if (!re.m) {
...
mkt.regrasValidas = (container, ev = null) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let resultado = [];
    resultado = yield Promise.all(promises);
    ...
    if (!validou) {
        ...
        resultado.flat().forEach((r) => {
            var _c, _d;
            mkt.gc("Regra:", (_c = r.k) === null || _c === void 0 ? void 0 : _c.toString().toUpperCase(), "Campo: " + ((_d = r.e) === null || _d === void 0 ? void 0 : _d.name));
            mkt.l(r.e);
            mkt.ge();
        });
        mkt.ge();
...
mkt.regraDisplay = (e, erro, eDisplay, mensagem = "") => {
    if (erro === true) {
        e.classList.remove("valid");
        e.classList.add("input-validation-error");
        eDisplay === null || eDisplay === void 0 ? void 0 : eDisplay.classList.remove("oculto");
        eDisplay === null || eDisplay === void 0 ? void 0 : eDisplay.classList.add("field-validation-error");
    }
    else if (erro === false) {
        ...
        eDisplay === null || eDisplay === void 0 ? void 0 : eDisplay.classList.add("oculto");
    }
    else {
        e.classList.remove("valid");
        e.classList.remove("input-validation-error");
...
mkt.regraOcultar = (container, deixaValido = false) => {
    container = mkt.Q(container);
    mkt.regras.forEach((r) => {
        let e = r.e;
...
mkt.regraRemover = (container) => __awaiter(void 0, void 0, void 0, function* () {
    container = mkt.Q(container);
    let tempRegras = [];
    mkt.regras.forEach((r) => {
...
mkt.regrarAtivador = (e, nomeRegra, turnON = true) => {
    if (nomeRegra != null) {
        e = mkt.Q(e);
        if (e) {
...
mkt.regrar = (container, nome, ...obj) => {
    if (typeof nome != "string") {
        return mkt.w("Regrar() precisa receber o nome do input como string");
    }
    container = mkt.Q(container);
    let e = container === null || container === void 0 ? void 0 : container.querySelector("*[name='" + nome + "']");
    if (e) {
    ...
    if (mascara) {
        if (texto) {
            if (mkt.classof(texto) != "String")
                texto = texto === null || texto === void 0 ? void 0 : texto.toString();
            if (mkt.classof(mascara) != "String")
                mascara = mascara === null || mascara === void 0 ? void 0 : mascara.toString();
...
mkt.ordenar = (array, nomeProp, sortDir) => {
    if (nomeProp) {
        array.sort((oA, oB) => {
...
mkt.toBooleanOA = (oa) => {
    let toBoolean_Execute = (o) => {
        ...
        for (let propName in o) {
            let comparado = (_d = (_c = o[propName]) === null || _c === void 0 ? void 0 : _c.toString()) === null || _d === void 0 ? void 0 : _d.toLowerCase();
            if (comparado == "true") {
                o[propName] = true;
            }
            if (comparado == "false") {
...
mkt.aCadaSubPropriedade = (OA, funcao = null, exceto = "Object") => {
    let c = 0;
    for (let a in OA) {
...
mkt.parseJSON = (t, removeRaw = false) => {
    if (removeRaw) {
...
mkt.stringify = (o) => {
    var _c, _d, _e, _f, _g;
    return (_g = (_f = (_e = (_d = (_c = JSON.stringify(o)) === null || _c === void 0 ? void 0 : _c.replace(new RegExp("\n", 'g'), "")) === null || _d === void 0 ? void 0 : _d.replace(new RegExp("\r", 'g'), "")) === null || _e === void 0 ? void 0 : _e.replace(new RegExp("\t", 'g'), "")) === null || _f === void 0 ? void 0 : _f.replace(new RegExp("\b", 'g'), "")) === null || _g === void 0 ? void 0 : _g.replace(new RegExp("\f", 'g'), "");
};
mkt.clicarNaAba = (e) => {
    let pag = Number(e === null || e === void 0 ? void 0 : e.getAttribute("data-pag"));
    if (mkt.classof(pag) == "Number") {
        let mkAbasTotal = 0;
        let mkAbas = e.closest(".mkAbas");
        mkAbas === null || mkAbas === void 0 ? void 0 : mkAbas.querySelectorAll("a").forEach((a) => {
...
mkt.Workers = (numWorkers = navigator.hardwareConcurrency || 5) => {
    if (numWorkers > 3)
        numWorkers = 3;
    if (numWorkers < 1)
        numWorkers = 1;
    return new Promise((r) => {
        ...
        let workerBlob = window.URL.createObjectURL(new Blob([(_c = mkt.Q("#mktWorker")) === null || _c === void 0 ? void 0 : _c.textContent], { type: "text/javascript" }));
        class WorkerPool {
...
mkt.addTask = (msg, numWorkers = undefined) => {
    return new Promise((r) => {
        if (!mkt.a.wpool) {
...
mkt.apenasNumerosLetras = (s = "") => {
    if (s == null)
        return "";
    return s.replace(/(?![a-zA-Z0-9])./g, "");
};
mkt.nodeToScript = (node) => {
...
mkt.isInside = (e, container) => {
    ...
    if (e) {
        ...
        while (ePai != mkt.Q("BODY") && c < 100) {
            if (ePai) {
                ePai = ePai === null || ePai === void 0 ? void 0 : ePai.parentElement;
                if (ePai == container) {
                    resultado = true;
                    break;
                }
...
mkt.allParentOffset = (e) => {
    ...
    if ((last === null || last === void 0 ? void 0 : last.tagName) == "BODY") {
        return 0;
    }
    else {
        return conta;
...
mkt.Reposicionar = (e, largura = null, local = "bottom-start") => {
...
mkt.eToText = (query) => {
    ...
    if (e) {
        ...
        ePai === null || ePai === void 0 ? void 0 : ePai.insertBefore(div, ePai === null || ePai === void 0 ? void 0 : ePai.children[Array.from(ePai === null || ePai === void 0 ? void 0 : ePai.children).indexOf(e) + 1]);
        e.remove();
        return div;
    }
    return null;
};
mkt.getEFromNames = (arrayNames = [], classe = "*") => {
...
mkt.geraObjForm = (form, bool = false, clear = false) => {
...
mkt.GetParam = (name = null, url = null) => {
    if (!url)
...
mkt.downloadData = (base64, nomeArquivo = "Arquivo") => {
...
mkt.onlyFloatKeys = (ev) => {
    var _c;
    let permitido = "0123456789,-";
    let isNegado = true;
    for (var i = 0; i < permitido.length; i++) {
        if (permitido[i] == ((_c = ev.key) === null || _c === void 0 ? void 0 : _c.toString())) {
            isNegado = false;
        }
    }
...
mkt.formatarNumValue = (e) => {
    e.value = mkt.numToDisplay(e.value);
};
mkt.fileReader = (arquivo, eventos) => __awaiter(void 0, void 0, void 0, function* () {
    return new Promise((r) => {
...
mkt.getExclusivos = (array) => __awaiter(void 0, void 0, void 0, function* () {
    let res = yield mkt.addTask({ k: "Exclusivos", v: array });
    return res.v;
});
mkt.encheArray = (arrTemplate, inicio = 1, total) => {
    let novaArray = [];
...
mkt.encheArrayUltimos = (arrTemplate, fim = 1, total) => {
    let novaArray = [];
    if (Array.isArray(arrTemplate)) {
        if (arrTemplate.length > 0) {
...
mkt.fase = (possiveis, config) => {
    class FasearMK {
        ...
        avancar(novaFase = null) {
            return __awaiter(this, void 0, void 0, function* () {
                return new Promise((r, err) => __awaiter(this, void 0, void 0, function* () {
                    if (yield mkt.regrasValidas(".modalFase" + this.atual)) {
                        if (novaFase) {
        ...
        update() {
            mkt.QAll(this.config.classe + " ul.mkUlFase li a").forEach((e) => {
                var _c, _d, _e, _f, _g, _h;
                (_c = e.parentElement) === null || _c === void 0 ? void 0 : _c.classList.remove("mkFaseBack");
                (_d = e.parentElement) === null || _d === void 0 ? void 0 : _d.classList.remove("mkFaseAtivo");
                (_e = e.parentElement) === null || _e === void 0 ? void 0 : _e.classList.remove("disabled");
                ...
                if (this.possiveis.indexOf(this.atual) > this.possiveis.indexOf(eNumPag)) {
                    (_f = e.parentElement) === null || _f === void 0 ? void 0 : _f.classList.add("mkFaseBack");
                }
                if (this.possiveis.indexOf(this.atual) == this.possiveis.indexOf(eNumPag)) {
                    (_g = e.parentElement) === null || _g === void 0 ? void 0 : _g.classList.add("mkFaseAtivo");
                }
                if (bLibera == "false") {
                    (_h = e.parentElement) === null || _h === void 0 ? void 0 : _h.classList.add("disabled");
                }
            });
            for (let i = 0; i < this.possiveis.length; i++) {
                let elemento = mkt.Q(this.config.classe + " .modalFase" + this.possiveis[i]);
                if (elemento) {
                    elemento === null || elemento === void 0 ? void 0 : elemento.classList.add("oculto");
                }
                else {
...
mkt.mkInclude = () => __awaiter(void 0, void 0, void 0, function* () {
    return new Promise((r) => {
        mkt.QAll("body *").forEach((e) => __awaiter(void 0, void 0, void 0, function* () {
            let destino = e.getAttribute("mkInclude");
            if (destino != null) {
                let p = yield mkt.get.html({ url: destino, quiet: true });
                if (p.retorno != null) {
...
mkt.capitalize = (string) => {
    return string.charAt(0).toUpperCase() + string.slice(1);
};
mkt.vibrar = (tipo) => __awaiter(void 0, void 0, void 0, function* () {
    if (tipo === false) {
...
mkt.Terremoto = (e = null) => {
    mkt.timerClasse(e, "mkTerremoto", 500);
};
mkt.timerClasse = (e, classe, tempo = 1000) => {
    e = mkt.Q(e);
    if (e) {
...
mkt.loadImage = (urlData) => __awaiter(void 0, void 0, void 0, function* () {
...
mkt.serializeAsXML = (e) => (new XMLSerializer()).serializeToString(e);
mkt.svgToImg = (foreignObject, formatoDestino = "png", largura = 800, altura = 600, qualidade = 1.0) => __awaiter(void 0, void 0, void 0, function* () {
    var _f;
    ...
    let eImg = yield mkt.loadImage(svgData).catch(e => console.error(e));
    if (eImg) {
        const eCanvas = document.createElement('canvas');
        eCanvas.width = largura;
        eCanvas.height = altura;
        (_f = eCanvas === null || eCanvas === void 0 ? void 0 : eCanvas.getContext('2d')) === null || _f === void 0 ? void 0 : _f.drawImage(eImg, 0, 0);
        return yield eCanvas.toDataURL(`image/${formatoDestino}`, qualidade);
    }
});
mkt.convertToNumeric = (texto) => {
    let arrayDeNumeros = [];
...
mkt.convertToTexto = (numeric) => {
    return String.fromCodePoint(...numeric);
};
mkt.frequencia = (array) => {
    let f = {};
    for (let e of array) {
        let s = e;
...
class mkSel extends HTMLElement {
    constructor() {
            ...
            pesquisaKeyDown: (ev) => {
                ...
                if (ev.key == "ArrowUp" || ev.key == "ArrowDown" || ev.key == "Enter") {
                    ...
                    if (ev.key == "ArrowUp") {
                        ...
                        eListItem === null || eListItem === void 0 ? void 0 : eListItem.setAttribute("m", "1");
                        let alvoOffsetTop = (eListItem === null || eListItem === void 0 ? void 0 : eListItem.offsetTop) || 0;
                ...
                if (novoK != null) {
                    ...
                    if (mkt.classof(this.config.selapenas) == "Number") {
                        if (this.config.selapenas == 1) {
                            ...
                            this.config.selecionados.set(novoK === null || novoK === void 0 ? void 0 : novoK.toString(), novoV === null || novoV === void 0 ? void 0 : novoV.toString());
                            this.value = novoK;
                            this.config.updateSelecionadosValues();
        ...
        this.atualizarDisplay = () => __awaiter(this, void 0, void 0, function* () {
            var _l, _m, _o;
            ...
            if (this.config.selecionados.size != 0) {
                if (this.config.selapenas == 1) {
                    if ((_l = this.getFirstSelecionado) === null || _l === void 0 ? void 0 : _l[1]) {
                        display = (_m = this.getFirstSelecionado) === null || _m === void 0 ? void 0 : _m[1];
                    }
                    else {
                        if (((_o = this.getFirstSelecionado) === null || _o === void 0 ? void 0 : _o[0]) !== "") {
                            display = null;
                        }
                    }
                }
...
<svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' style='-webkit-box-reflect: right;' viewBox='0 0 16 16'><path fill-rule='evenodd' d='M8 1a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 .708-.708L7.5 13.293V1.5A.5.5 0 0 1 8 1'/></svg>
        ...
        (_c = this.shadowRoot) === null || _c === void 0 ? void 0 : _c.append(template.content);
        this.config.eK = (_d = this.shadowRoot) === null || _d === void 0 ? void 0 : _d.querySelector(".k");
        this.config.eList = (_e = this.shadowRoot) === null || _e === void 0 ? void 0 : _e.querySelector(".lista");
        this.config.eUL = (_f = this.shadowRoot) === null || _f === void 0 ? void 0 : _f.querySelector(".lista ul");
        this.config.rolaCima = (_g = this.shadowRoot) === null || _g === void 0 ? void 0 : _g.querySelector(".rolaCima");
        this.config.rolaBaixo = (_h = this.shadowRoot) === null || _h === void 0 ? void 0 : _h.querySelector(".rolaBaixo");
        this.config.svg = (_j = this.shadowRoot) === null || _j === void 0 ? void 0 : _j.querySelector(".arrowAbreFecha");
        if (this.getAttribute("scrollcharge"))
            this.config.scrollcharge = ((_k = this.getAttribute("scrollcharge")) === null || _k === void 0 ? void 0 : _k.toString().toLowerCase()) != "false";
            ...
            if (mkt.classof(colect) == "Array") {
                if (mkt.classof(colect[0]) == "Array") {
                    ...
                    if (mkt.classof(colect[0]) == "Object") {
                        colect = colect.map((r) => { var _c, _d; return [(_c = r.k) === null || _c === void 0 ? void 0 : _c.toString().replaceAll(",", ""), (_d = r.v) === null || _d === void 0 ? void 0 : _d.toString()]; });
                    }
                    else {
                        colect = null;
                    }
        ...
        if (mkt.classof(this.config.selapenas) == "Number") {
            if (this.config.selapenas == 1) {
                ...
                if (mkt.isJson(this.value)) {
                    ...
                    if (mkt.classof(colect) == "Array") {
                        let map = new Map(mkt.parseJSON(this.value).map((a) => { return [a === null || a === void 0 ? void 0 : a.toString()]; }));
                        this.config.selecionados = map;
                        this.config.updateSelecionadosValues();
                    }
                    else {
                        if (colect != null) {
                            let array = (_c = this.value) === null || _c === void 0 ? void 0 : _c.split(",").map((a) => { return [a === null || a === void 0 ? void 0 : a.toString()]; });
    ...
    aoFocus() {
        ...
        let primeiroOffSet = (ePrimeiroSel === null || ePrimeiroSel === void 0 ? void 0 : ePrimeiroSel.offsetTop) || 0;
        this.config.eList.scrollTop =
    ...
    aoInput() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.config.eUL.children.length < this.config._data.size) {
                yield this.maisLinhas(this.config.populado, this.config._data.size);
            }
            if (this.pos) {
                ...
                if (strTratada.length > 3) {
                    if (this.config.url != "") {
                        ...
                        let r = yield mkt.get.json({ url: novaUrl });
                        if (r.retorno != null) {
    ...
    maisLinhas(inicio, total) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield mkt.moldeOA(dadosFiltrado, linha, hold);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (mkt.classof(this.config._data) == "Map") {
                if (this.config.scrollcharge) {
                    yield this.maisLinhas(this.config.populado, 10);
                }
                else {
                    yield this.maisLinhas(this.config.populado, this.config._data.size);
                }
    ...
    refill(url = null) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (urlExecutar) {
                let r = yield mkt.get.json({ url: urlExecutar });
                if (r.retorno != null) {
    ...
    get getFirstSelecionado() { var _c; return ((_c = [...this.selecionadosMap]) === null || _c === void 0 ? void 0 : _c[0]) || null; }
...
mkSel.observedAttributes = ["disabled", "size", "value", "name", "opcoes", "url", "scrollbarwidth", "scrollbarcolor", "selapenas", "refill", "pos", "class"];
...
`;
        (_c = this.shadowRoot) === null || _c === void 0 ? void 0 : _c.append(template.content);
        this.config.area = (_d = this.shadowRoot) === null || _d === void 0 ? void 0 : _d.querySelector(".area");
        this.config.sobreposto = (_e = this.shadowRoot) === null || _e === void 0 ? void 0 : _e.querySelector(".sobreposto");
        this.config.name = this.getAttribute("name");
...
mkBot.observedAttributes = ["disabled", "value", "name", "inicial"];
