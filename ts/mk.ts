...
class mk {
	...
	headMenuAbrir = (colName: any, e: any) => {
		...
		if (this.c.objFiltro[colName]) mk.Q(".mkHeadMenu input[name='filtrarCampo']").value = this.c.objFiltro[colName]?.conteudo;
	...
	static getExclusivos = (array: any) => {
		let chaves = new Set();
